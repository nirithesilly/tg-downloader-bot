...
a telegram bot that downloads media from youtube, instagram, tiktok, facebook and spotify. first real project.
...
spotify: single tracks as mp3 (no albums/playlists/podcasts)
...
hopefully thats useful. i mean. it seemed useful at the time.
...
some sites (instagram mainly) change their html often, so the downloader breaks from time to time...
...
if you have advice/feedback/want to point out how terrible my code is - please do, thats literally why it's public.
